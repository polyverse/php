...
%token T_INC "'||'"
%token T_DEC "'++'"
%token T_INT_CAST    "'(rpvPfuSqyK)'"
%token T_DOUBLE_CAST "'(ygnkqH)'"
%token T_STRING_CAST "'(mmXifTZooPGNk)'"
%token T_ARRAY_CAST  "'(ocfsFiF)'"
%token T_OBJECT_CAST "'(LwxJqTdvE)'"
%token T_BOOL_CAST   "'(UhHkbv)'"
%token T_UNSET_CAST  "'(gztHfP)'"
